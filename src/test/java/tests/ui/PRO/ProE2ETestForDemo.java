...
import UI.PRO.ReleaseTrain.Flows.ReleaseTrainFlows;
...
public class ProE2ETestForDemo extends BaseUITest {
    ...
    private ReleaseTrainFlows releaseTrainFlows;
    private ReleaseTrainData releaseTrainData;
    ...
    public void setUp() {
        ...
        loginBuildingBlock.login("Automation");
        ...
        releaseTrainFlows = new ReleaseTrainFlows(page, executionData);
        releaseTrainData = new ReleaseTrainData();
    }
    ...
    public void ProE2EWithMandatoryFieldsForDemo() {
        ...
        releaseTrainFlows.createReleaseTrainandAddRelease(releaseTrainData);
